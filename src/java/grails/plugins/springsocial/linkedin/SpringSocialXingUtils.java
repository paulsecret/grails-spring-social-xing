...
public final class SpringSocialXingUtils {

    private static ConfigObject config;

    private SpringSocialXingUtils() {
        // static only
    }
    ...
    public static void reloadConfig() {
        mergeConfig(XingReflectionUtils.getConfig(), "DefaultSpringSocialXingConfig");
    }
	...
	private static void mergeConfig(final ConfigObject currentConfig, final String className) {
        GroovyClassLoader classLoader = new GroovyClassLoader(SpringSocialXingUtils.class.getClassLoader());
        ...
        XingReflectionUtils.setConfig(config);
    }
